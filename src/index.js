...
(function () {
  ...
  const loginPopupTemplate = document.querySelector('.popup_type_login');
  /* const signUpButton = loginPopup.querySelector('.popup__link'); */

  const signUpPopupTemplate = document.querySelector('.popup_type_signup');
 ...
 */
  ...
  /* const loginpPopupValidator = new FormValidator(loginPopup); */
  const signUpPopupValidator = new FormValidator(signUpPopupTemplate);

  const signUpPopup = new SignUpPopup(signUpPopupTemplate, signUpPopupValidator);
  ...
  authorizationButton.addEventListener('click', signUpPopup.open);
}());
